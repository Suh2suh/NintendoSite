        ...
        <section id="mainContents">
            ...
            <article>
                <?php
                    $num = $_GET["num"];
                ?>
                <form name="board_form" id="insertForm" method="post" action="qnaModify.php?num=<?=$num?>" enctype="multipart/form-data">
                    ...
                    <ul class="buttons">
                        <li><button type="button" id="submitBtn" onclick="check_input()">수 정</button></li>
                    </ul>
                </form>
            </article>
        </section>
